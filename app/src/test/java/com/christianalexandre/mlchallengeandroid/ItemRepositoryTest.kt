...
class ItemRepositoryTest {
    ...
    @Test
    fun `test search success when data has nullable values`() =
        runTest {
    ...
    // region Item Detail
    @Test
    fun `test get item detail success`() =
        runTest {
    ...
    @Test
    fun `test get item detail error`() =
        runTest {
            val responseMock =
                ApiResponse.Error<com.christianalexandre.data.model.itemdetail.ItemDetailDTO>(
    ...
    @Test
    fun `test get item detail success when data has nullable values`() =
        runTest {
    ...
    @Test
    fun `test get item description success`() =
        runTest {
    ...
    @Test
    fun `test get item description error`() =
        runTest {
            val responseMock =
                ApiResponse.Error<ItemDescriptionDTO>(ApiException(500, "Exception mock"))
    ...
    @Test
    fun `test get item description success when data has nullable values`() =
        runTest {
    ...
    @Test
    fun `test get item category success`() =
        runTest {
    ...
    @Test
    fun `test get item category error`() =
        runTest {
    ...
    @Test
    fun `test get item category success when data has nullable values`() =
        runTest {
